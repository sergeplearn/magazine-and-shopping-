    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                ...
                <img src="{{ asset('shopimg/' . $shopping->image_path)  }}"
                     class="img-fluid  " alt="" />
            </div>
            <!--Grid column-->
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="p-4">
                    <div class="mb-3">
                        <a href="/shop_category/{{ $shopping->shopcategory->slug }}">
                            <span class="badge bg-dark me-1">Category {{$shopping->shopcategory->id}}</span>
                        </a>
                        <a href="">
                    ...
                    <strong><p style="font-size: 20px;">{{ $shopping->title }}</p></strong>
